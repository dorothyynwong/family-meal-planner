...
public class WebScrappingServiceTests
{
    ...
    public async Task ImportRecipe_ValidUrl_ReturnsRecipe()
    {
        ...
        recipe.Author = "Jules Mercer";
        recipe.Url = "https://www.bbc.co.uk/food/recipes/air_fryer_chicken_kyiv_98492";
        ...
        recipe.RecipeCuisine = "East European";
